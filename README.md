# برازنده — نسخه استاتیک دقیق UI (برای GitHub Pages)
...
- ۲۰ محصول در ۴ دسته‌بندی: شومیز، تیشرت زنانه، پیراهن زنانه، دامن
- ۲ مقاله تستی کامل در بخش مجله (راهنمای سایز و نگهداری پارچه)
